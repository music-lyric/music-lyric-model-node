...
import type { Meta, MetaCredit, MetaReference, MetaText, MetaUnknown } from '@root/storage/proto'

import { MetaCreditSchema, MetaReferenceSchema, MetaSchema, MetaTextSchema, MetaUnknownSchema } from '@root/storage/proto'
